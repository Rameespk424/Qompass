...
import categoriesData from '../data/categories.json'; // Path to your JSON file
import { FiCpu, FiCoffee, FiSmartphone, FiBox } from 'react-icons/fi'; // Import icons
...
const ProductCategory = ({ onCategorySelect }) => {
  ...
  const handleCategoryClick = (category) => {
    ...
    if (onCategorySelect) {
      onCategorySelect(category.name); // Trigger callback with selected category
    }
  };
